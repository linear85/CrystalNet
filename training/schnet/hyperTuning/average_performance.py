...
df = pd.DataFrame(res)
df.columns=["hidden_layer_size", "filters", "interactions", "gaussians", "lr", "optimizer", "training_loss_mean", "validation_loss_mean", "training_loss_std", "validation_loss_std"]
