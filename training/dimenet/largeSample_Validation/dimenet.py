...
train_data_path = "../../../../dataset/features/GNN/AtomicNumberPos_54"
train_data, _ = LoadData(train_data_path).transformInput(partition=-1)

validation_data_path = "../../../../dataset/features/GNN/AtomicNumberPos_8192"
...
gnn_model = Model(hidden_channels=hidden_channels, num_bilinear=num_bilinear, num_blocks=num_blocks)
gnn_model.to(device)
